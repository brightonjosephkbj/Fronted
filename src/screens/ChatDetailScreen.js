...
const styles = StyleSheet.create({
  ...
  inputInner: { flexDirection: 'row', alignItems: 'flex-end', gap: 8, padding: 8, minHeight: 50, borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.5)' },
  ...
  textInput: { flex: 1, fontSize: 14, color: '#0f0f1a', maxHeight: 100, minHeight: 34, paddingHorizontal: 8, paddingVertical: 10 },
